...
export class Runtime {
    ...
    private functions: Map<FunctionName, FuncCall> = new Map([
        ...
        ["SCALECATEGORICAL", GraphFunctions.scaleCategorical],

        ["TEXT", GraphFunctions.text],
        ...
        ["STROKECOLOR", GraphFunctions.strokeColor],
        ["FONT", GraphFunctions.font],

        ["NEST", GraphFunctions.nest],
        ["NESTX", GraphFunctions.nestX],
        ["NESTY", GraphFunctions.nestY],
        ["SCALE", GraphFunctions.scale],
        ["SCALEX", GraphFunctions.scaleX],
